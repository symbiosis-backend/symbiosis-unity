    ...
    public static class TutorialLayouts
    {
        ...
        public static List<LayoutSlot> Stage07_16Tiles()
        {
            return new List<LayoutSlot>
            {
                ...
                S(-3, 1, 0), S(-2, 1, 0), S(-1, 1, 0), S(0, 1, 0),
                S(1, 1, 0),  S(2, 1, 0),
                S(-1, 0, 1), S(0, 0, 1)
            };
        }
        ...
        public static List<LayoutSlot> Stage09_20Tiles()
        {
            return new List<LayoutSlot>
            {
                S(-4, 0, 0), S(-3, 0, 0), S(-2, 0, 0), S(-1, 0, 0),
                S(0, 0, 0),  S(1, 0, 0),  S(2, 0, 0),  S(3, 0, 0),
                S(-4, 1, 0), S(-3, 1, 0), S(-2, 1, 0), S(-1, 1, 0),
                S(0, 1, 0),  S(1, 1, 0),  S(2, 1, 0),  S(3, 1, 0),
                S(-2, 0, 1), S(-1, 0, 1), S(0, 0, 1),  S(1, 0, 1)
            };
        }
        ...
        public static List<LayoutSlot> Stage10_24Tiles()
        {
            return new List<LayoutSlot>
            {
                S(-5, 0, 0), S(-4, 0, 0), S(-3, 0, 0), S(-2, 0, 0),
                S(-1, 0, 0), S(0, 0, 0),  S(1, 0, 0),  S(2, 0, 0),
                S(3, 0, 0),  S(4, 0, 0),
                S(-4, 1, 0), S(-3, 1, 0), S(-2, 1, 0), S(-1, 1, 0),
                S(0, 1, 0),  S(1, 1, 0),  S(2, 1, 0),  S(3, 1, 0),
                S(-3, 2, 0), S(-2, 2, 0), S(1, 2, 0),  S(2, 2, 0),
                S(-1, 0, 1), S(0, 0, 1)
            };
        }
