...
namespace MahjongGame
{
    ...
    public sealed class TrayUI : MonoBehaviour
    {
        ...
        private readonly HashSet<Tile> landedTiles = new();
        private readonly HashSet<Tile> breakingTiles = new();
        ...
        private IEnumerator AnimateIntoTray(Tile tile, int slotIndex)
        {
            flyingCounter++;
        ...
        private IEnumerator ProcessMatchQueue()
        {
            while (true)
            {
                ...
                if (!TryFindLandedMatch(out Tile a, out Tile b))
                    break;
        ...
        private bool TryFindLandedMatch(out Tile first, out Tile second)
        {
            first = null;
            second = null;
        ...
        private IEnumerator PlayMatchBreakAndDestroy(Tile a, Tile b)
        {
        ...
        private void RefreshSlotBackgrounds()
        {
            ...
            while (slotBackgrounds.Count < maxSlots)
            {
                GameObject go = new GameObject(
                    $"TraySlotBg_{slotBackgrounds.Count}",
