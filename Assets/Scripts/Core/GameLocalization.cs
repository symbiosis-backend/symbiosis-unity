...
namespace MahjongGame
{
    public static class GameLocalization
    {
        ...
        private static readonly Dictionary<string, Translation> Translations = new(StringComparer.Ordinal)
        {
            ...
            { "battle.character.disabled", new Translation("Недоступен", "Disabled", "Kapalı") },
            ...
            { "battle.character.rail.owned", new Translation("КУПЛЕН", "OWNED", "ALINDI", "IM BESITZ") },
            { "battle.character.rail.class", new Translation("Класс:\n{0}", "Class:\n{0}", "Sınıf:\n{0}", "Klasse:\n{0}") },
            { "battle.character.rail.class.fighter", new Translation("Боец", "Fighter", "Savaşçı", "Kämpfer") },
            { "battle.character.rail.class.vanguard", new Translation("Авангард", "Vanguard", "Öncü", "Vorhut") },
            { "battle.character.rail.class.scout", new Translation("Разведчик", "Scout", "İzci", "Späher") },
            { "battle.character.rail.class.duelist", new Translation("Дуэлянт", "Duelist", "Düellocu", "Duellant") },
            { "battle.character.rail.class.sentinel", new Translation("Страж", "Sentinel", "Nöbetçi", "Wächter") },
            { "battle.character.rail.class.arcanist", new Translation("Арканист", "Arcanist", "Arkanist", "Arkanist") },
            { "battle.character.rail.class.tracker", new Translation("Следопыт", "Tracker", "İz Sürücü", "Fährtenleser") },
            { "battle.character.rail.first_free", new Translation("ПЕРВЫЙ ГЕРОЙ БЕСПЛАТНО", "FIRST HERO FREE", "İLK KAHRAMAN ÜCRETSİZ", "ERSTER HELD GRATIS") },
            { "battle.character.rail.buy", new Translation("Купить: {0} {1}", "Buy: {0} {1}", "Satın al: {0} {1}", "Kaufen: {0} {1}") },
            ...
            { "battle.character.stat.armor", new Translation("Броня", "Armor", "Zırh") },
